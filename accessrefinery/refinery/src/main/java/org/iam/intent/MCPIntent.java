...
public class MCPIntent {
    ...
    /**
     * -Dopt.am: whether getMCPNode() may build on the parent's node via the refinement DAG.
     * Cached once because getMCPNode() is on the miner's hot path and system properties are
     * only set at JVM startup.
     */
    private static final boolean OPT_AM = Parameter.isOptAM();
    /**
    ...
    public MCPBitVector getMCPNode() {
        ...
        if(OPT_AM && _parentIntent != null && _refinedKey != null) {
