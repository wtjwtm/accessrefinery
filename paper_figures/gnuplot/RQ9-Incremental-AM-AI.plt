...
# Output settings
set output 'results/RQ9-Incremental-AM-AI.pdf'
...
plot 'data/p3_05.dat' using 1:2 w lp ls 1 title 'MCILabels (original)', \
...
plot 'data/p3_06.dat' using 1:2 w lp ls 1 notitle, \
     '' using 1:3       w lp ls 2 notitle
...
plot 'data/p3_07.dat' using 1:2 w lp ls 1 notitle, \
...
plot 'data/rw_p3.dat' using 1:2 w l ls 1 notitle, \
